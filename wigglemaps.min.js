...
$(document).bind("mousemove",function(g){e&&d&&(b=a.camera.percent(new vect(g.clientX,g.clientY)),f.update(u(c,b),0))});this.enable=function(){e=!0};this.disable=function(){e=!1};this.draw=function(){d&&(gl.useProgram(V),V.data("pos",f),V.data("edge_in",j),gl.drawArrays(gl.TRIANGLES,0,f.numItems))}}function Ca(a,e){for(;a>=e;)a-=e;for(;0>a;)a+=e;return a}function Va(a,e,d,c){this.current=a;this.upper=e;this.lower=d;this.index=c}function Da(a,e){for(var d=0;d<a.length;d++)if(a[d]==e)return!0;return!1}
...
c;for(c in X)d[c]=new X[c].collection(a.type(c).items());j=!1};this.draw=function(){j&&this.update();if(!c)throw"Layer has not yet been initialized";for(var a in e)e[a].draw()}}function Ha(a){var e=new vect(Infinity,Infinity),d=new vect(-Infinity,-Infinity);$.each(a,function(a,b){$.each(b,function(a,c){$.each(c,function(a,c){c[0]<e.x&&(e.x=c[0]);c[0]>d.x&&(d.x=c[0]);c[1]<e.y&&(e.y=c[1]);c[1]>d.y&&(d.y=c[1])})})});return new W(e,d)}function Xa(a,e){for(var d=a.alloc(6*e.length),c=0,b=function(){if(e[c]){var a=
new vect(e[c][0],e[c][1]);c++;return a}return null},f=[],j=[],h=function(a,c,b,d){d?(a[b]=-c.x,a[b+1]=-c.y):(a[b]=c.x,a[b+1]=c.y)},g=function(a,c,b,d){h(a,c,0,!1);h(a,b,2,!1);h(a,c,4,d);h(a,b,6,d);h(a,c,8,d);h(a,b,10,!1)},k=b(),m=b(),q=b(),l=vect.dir(m,k).rotate(qa/2),n,p=d;m;)n=q?vect.dir(q,k).rotate(qa/2):vect.dir(m,k).rotate(qa/2),g(f,k,m,!1),g(j,l,n,!0),a.write("vert",f,p,6),a.write("norm",j,p,6),p+=6,k=m,m=q,q=b(),l=n;return d}function ra(a){D||(D=B(engine.gl,z+"shaders/grid"));a||(a={});a.style||
...
(gl.useProgram(K),K.data("screen",a.camera.mat3),K.data("pos",b),K.data("tex_in",c),K.data("sampler",this.image),gl.drawArrays(gl.TRIANGLES,0,b.numItems))}}function sa(a){v||(v=B(z+"shaders/hillshade"));var e=$(a).find("LatLonBox"),d=new vect(parseFloat(e.find("west").text()),parseFloat(e.find("south").text())),c=new vect(parseFloat(e.find("east").text()),parseFloat(e.find("north").text()));a=$(a).find("GroundOverlay Icon href").text();var b=!1,f=ca(a,function(){b=!0});this.ready=function(){return b};
...
0,h.numItems);return g}}}function sa(a){v||(v=B(engine.gl,z+"shaders/hillshade"));var e=$(a).find("LatLonBox"),d=new vect(parseFloat(e.find("west").text()),parseFloat(e.find("south").text())),c=new vect(parseFloat(e.find("east").text()),parseFloat(e.find("north").text()));a=$(a).find("GroundOverlay Icon href").text();var b=!1,f=ca(engine.gl,a,function(){b=!0});this.ready=function(){return b};var j=H(engine.gl,u(new vect(0,1),new vect(1,0)),2),h=H(engine.gl,u(d,c),2),g=315;this.initialize=function(){};
...
Math.pow(2,c);b.cols=2*b.rows;b.cellsize=180/b.rows;b.z_index=1-ta-c/1E3;b.available=d;b=new Za(b);e.push(b)}ta+=(a.levels+2)/1E3;var f=null;this.initialize=function(a){A||(A=B(a.gl,z+"shaders/tile"));f=new P(a.gl,6*Y);f.create("vert",3);f.create("tex",2);f.create("lookup",1);f.alloc(6*Y);for(var c=0;25>c;c++)d.push(new ja(a.gl));for(c=0;c<e.length;c++)e[c].initialize(a);e[0].fetch_all();e[0].noexpire(!0)};this.draw=function(c,b){gl.useProgram(A);A.data("screen",c.camera.mat3);Ia=Ja=0;for(var d=Infinity,
k=e[0],m,q=0;q<e.length;q++){var l=a.size*e[q].cols/e[q].size(c).x;1>l&&(l=1/l);l<d&&(d=l,k=e[q],m=q)}for(q=m;0<=q;q--)e[q].fetch();if(k.ready())k.draw(c,b,f,0,!0);else{c.enable_z();d=0;for(q=m;0<=q;q--)d=e[q].draw(c,b,f,d,0==q);c.disable_z()}$.each(e,function(a,c){c.cull()})}}function Za(a){a||(a={});a.desaturate||(a.desaturate=0);a.darken||(a.darken=0);a.hue||(a.hue=0);a.hue_color||(a.hue_color=wa(0,0,0,1));if(!a.available){a.available=[];for(var e=0;8>e;e++)a.available.push(new ja(d))}var d=null,
...
g++;Ja++;g>=Y&&(c(),g=0)}h&&c();return g}}var z="",S=jQuery,ab=function(a){if("string"===typeof a.data){var e=a.handler,d=a.data.toLowerCase().split(" ");a.handler=function(a){if(!(this!==a.target&&(/textarea|select/i.test(a.target.nodeName)||"text"===a.target.type))){var b="keypress"!==a.type&&S.hotkeys.specialKeys[a.which],f=String.fromCharCode(a.which).toLowerCase(),j="",h={};a.altKey&&"alt"!==b&&(j+="alt+");a.ctrlKey&&"ctrl"!==b&&(j+="ctrl+");a.metaKey&&(!a.ctrlKey&&"meta"!==b)&&(j+="meta+");
a.shiftKey&&"shift"!==b&&(j+="shift+");b?h[j+b]=!0:(h[j+f]=!0,h[j+S.hotkeys.shiftNums[f]]=!0,"shift+"===j&&(h[S.hotkeys.shiftNums[f]]=!0));b=0;for(f=d.length;b<f;b++)if(h[d[b]])return e.apply(this,arguments)}}}};S.hotkeys={version:"0.8",specialKeys:{8:"backspace",9:"tab",13:"return",16:"shift",17:"ctrl",18:"alt",19:"pause",20:"capslock",27:"esc",32:"space",33:"pageup",34:"pagedown",35:"end",36:"home",37:"left",38:"up",39:"right",40:"down",45:"insert",46:"del",59:";",96:"0",97:"1",98:"2",99:"3",100:"4",
101:"5",102:"6",103:"7",104:"8",105:"9",106:"*",107:"=",109:"-",110:".",111:"/",112:"f1",113:"f2",114:"f3",115:"f4",116:"f5",117:"f6",118:"f7",119:"f8",120:"f9",121:"f10",122:"f11",123:"f12",144:"numlock",145:"scroll",186:";",187:"=",188:",",189:"-",190:".",191:"/",219:"[",220:"\\",221:"]",222:"'",224:"meta"},shiftNums:{"`":"~",1:"!",2:"@",3:"#",4:"$",5:"%",6:"^",7:"&",8:"*",9:"(","0":")","-":"_","=":"+",";":":","'":'"',",":"<",".":">","/":"?","\\":"|","[":"{","]":"}"}};S.each(["keydown","keyup",
"keypress"],function(){S.event.special[this]={add:ab}});var J=jQuery,ua=function(a){var e=a||window.event,d=[].slice.call(arguments,1),c=0,b=0,f=0;a=J.event.fix(e);a.type="mousewheel";e.wheelDelta&&(c=e.wheelDelta/120);e.detail&&(c=-e.detail/3);f=c;void 0!==e.axis&&e.axis===e.HORIZONTAL_AXIS&&(f=0,b=-1*c);void 0!==e.wheelDeltaY&&(f=e.wheelDeltaY/120);void 0!==e.wheelDeltaX&&(b=-1*e.wheelDeltaX/120);d.unshift(a,c,b,f);return(J.event.dispatch||J.event.handle).apply(this,d)},T=["DOMMouseScroll","mousewheel"];
if(J.event.fixHooks)for(var L=T.length;L;)J.event.fixHooks[T[--L]]=J.event.mouseHooks;J.event.special.mousewheel={setup:function(){if(this.addEventListener)for(var a=T.length;a;)this.addEventListener(T[--a],ua,!1);else this.onmousewheel=ua},teardown:function(){if(this.removeEventListener)for(var a=T.length;a;)this.removeEventListener(T[--a],ua,!1);else this.onmousewheel=null}};J.fn.extend({mousewheel:function(a){return a?this.bind("mousewheel",a):this.trigger("mousewheel")},unmousewheel:function(a){return this.unbind("mousewheel",
...
3);c.create("alpha",1);var b=function(a){pa.call(this,a,e);d.create(a);var b,h;this.style_map={fill:function(a){c.repeat("color",a.array,b,h)},"fill-opacity":function(a){c.repeat("alpha",[a],b,h)}};a=a.geom;var g=[];h=0;$.each(a,function(a,c){for(var b,d=0;100>d;)try{for(var e=c,f=[],j=0;j<e.length;j++){for(var k=[],l=1;l<e[j].length;l++)k.push(La(e[j][l][0],e[j][l][1]));k.push(f[0]);f.push(k)}b=Wa(f);break}catch(n){d++}if(100==d)throw"Rendering Polygon Failed";h+=b.length/2;g.push(b)});var k=b=c.alloc(h);
...
function(a,b){d.push(b.style(c))});return d}if("function"==typeof b)$.each(a,function(a,d){d.style(c,b(d))});else{var e;a:if(null==b||void 0==b.length)e=!1;else{for(e=0;e<b.length;e++)if(!(e in b)){e=!1;break a}e=!0}e?$.each(a,function(a,d){d.style(c,b[a])}):$.each(a,function(a,d){d.style(c,b)})}return this}},K=null,v=null,N=null,v=null,$a=1E3,ta=0,Y=8,Ja=0,Ia=0,A=null,Oa=[];window.wiggle={Map:function(a,e){this.center=function(a,b){engine.camera.position(new vect(a,b))};this.vcenter=function(a){this.center(a.x,
...
if(!(c in a))throw"Key "+c+" not found";}n(a,{levels:16,size:256});var e={source:"wms"},b;for(b in e)a[b]=e[b];return new ea(a)}},util:{fcolor:wa,icolor:function(a,e,d,c){return new s(l(a/255,0,1),l(e/255,0,1),l(d/255,0,1),l(c/255,0,1))}},widget:{Slider:function(a,e,d){var c=function(a){if(a>=d)throw"Slider index out of bounds";return e.x/(d-1)*a},b=function(b){return b<=a.x?0:b>=a.x+e.x?d-1:Math.round((b-a.x)/e.x*(d-1))};this.dom=$("<div></div>").addClass("slider-container").css("position","relative").css("left",
a.x).css("top",a.y).css("width",e.x).css("height",e.y);var f=!1,j=0,h=$("<div></div>").addClass("slider-box").css("position","relative").css("left",-10).css("height",e.y).css("width",20).mousedown(function(){f=!0});this.tick=function(){return j};this.count=function(){return d};var g=function(){};this.change=function(a){g=a};var k=function(){};this.release=function(a){k=a};this.dragging=function(){return f};this.dom.append(h);this.set=function(a){a!=j&&g(a);j=a;var b=c(a);h.css("left",b-10);k(a)};
$(document).bind("mouseup",function(){if(f){f=!1;var a=b(event.clientX);k(a)}});$(document).bind("mousemove",function(a){f&&(a=b(a.clientX),a!=j&&g(a),j=a,a=c(a),h.css("left",a-10))})}},ready:function(a){Oa.push(a)}};$(document).ready(function(){$('script[src*="wigglemaps"]').each(function(a,e){var d=/wigglemaps(\.min)?\.js/;$(e).attr("src").match(d)&&(z=$(e).attr("src").replace(d,""))});$.each(Oa,function(a,e){e()})})})();
