...
2/a.canvas.width());E.data("px_h",2/a.canvas.height());gl.drawArrays(gl.TRIANGLES,0,d.count())}}function Ga(a){var e={},d={},b=!1,c={},f={},k=!1;if(a.style)for(var j in a.style)c[j]=a.style[j];this.style=function(a,d){if(2>arguments.length)return void 0!==c[a]?c[a]:null;c[a]=d;if(b)for(var f in e)e[f].update(a);return this};this.bounds=null;this.features=function(){var a=[],b;for(b in f)a.push(f[b]);return new t(a)};this.search=function(a){k&&this.update();var b=new t([]),c;for(c in d)var e=d[c].search(a),
b=b.join(e);return b};this.map_contains=function(a,b){k&&this.update();var c=new t([]),e;for(e in d)var f=d[e].map_contains(a,b),c=c.join(f);return c};this.append=function(a){a=new W[a.type].geometry(a,this);f[a.id]=a;this.bounds?this.bounds.union(a.bounds):this.bounds=a.bounds.clone();b&&a.initialize(e[a.type]);k=!0};var g=null,l=null;this.mouseover=function(a){g=a};this.mouseout=function(a){l=a};var n={};this.update_move=function(a,b){if(g||l){var c=this.map_contains(a,b),d={};c&&c.each(function(a,
